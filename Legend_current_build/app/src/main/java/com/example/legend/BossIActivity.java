    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boss1Button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                boss1Button.setTextColor(getResources().getColor(R.color.leg_sand));
                boss1Button.setBackgroundColor(getResources().getColor(R.color.leg_red));
                boss2Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss2Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                boss3Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss3Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                boss4Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss4Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        boss2Button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                //change the color of the buttons
                boss1Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss1Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                boss2Button.setTextColor(getResources().getColor(R.color.leg_sand));
                boss2Button.setBackgroundColor(getResources().getColor(R.color.leg_red));
                boss3Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss3Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                boss4Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss4Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        boss3Button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                boss2Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss2Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                boss3Button.setTextColor(getResources().getColor(R.color.leg_sand));
                boss3Button.setBackgroundColor(getResources().getColor(R.color.leg_red));
                boss4Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss4Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
            }
        });
        ...
        boss4Button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                boss3Button.setTextColor(getResources().getColor(R.color.leg_gold));
                boss3Button.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                boss4Button.setTextColor(getResources().getColor(R.color.leg_sand));
                boss4Button.setBackgroundColor(getResources().getColor(R.color.leg_red));
            }
        });
