...
public class CharacterIActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean[] statusButton = {true};
        ...
        empButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                empButton.setTextColor(getResources().getColor(R.color.leg_sand));
                empButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
                saiButton.setTextColor(getResources().getColor(R.color.leg_gold));
                saiButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                encButton.setTextColor(getResources().getColor(R.color.leg_gold));
                encButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                sagButton.setTextColor(getResources().getColor(R.color.leg_gold));
                sagButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                pirButton.setTextColor(getResources().getColor(R.color.leg_gold));
                pirButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        saiButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                //change the button colors
                empButton.setTextColor(getResources().getColor(R.color.leg_gold));
                empButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                saiButton.setTextColor(getResources().getColor(R.color.leg_sand));
                saiButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
                encButton.setTextColor(getResources().getColor(R.color.leg_gold));
                encButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                sagButton.setTextColor(getResources().getColor(R.color.leg_gold));
                sagButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        encButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                saiButton.setTextColor(getResources().getColor(R.color.leg_gold));
                saiButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                encButton.setTextColor(getResources().getColor(R.color.leg_sand));
                encButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
                sagButton.setTextColor(getResources().getColor(R.color.leg_gold));
                sagButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                pirButton.setTextColor(getResources().getColor(R.color.leg_gold));
                pirButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        sagButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                encButton.setTextColor(getResources().getColor(R.color.leg_gold));
                encButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                sagButton.setTextColor(getResources().getColor(R.color.leg_sand));
                sagButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
                pirButton.setTextColor(getResources().getColor(R.color.leg_gold));
                pirButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        pirButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                sagButton.setTextColor(getResources().getColor(R.color.leg_gold));
                sagButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                pirButton.setTextColor(getResources().getColor(R.color.leg_sand));
                pirButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(check1.isChecked() == false){
                    ...
                    //change the color of the buttons
                    confirmButton.setTextColor(getResources().getColor(R.color.leg_sand));
                    confirmButton.setBackgroundColor(getResources().getColor(R.color.leg_gray));
                    forwardButton.setColorFilter(getResources().getColor(R.color.white), PorterDuff.Mode.SRC_ATOP);
                }
            }
        });
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(check4.isChecked() == true){
                    ...
                    forwardButton.setColorFilter(getResources().getColor(R.color.leg_metal), PorterDuff.Mode.SRC_ATOP);
                }
                    ...
                    //change the color of the buttons
                    cancelButton.setTextColor(getResources().getColor(R.color.leg_sand));
        ...
        forwardButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                //if on boss rush mode it will send to the battle screen
                    ...
                    charStart.putExtra("mem1", teamSetup[0]);
                    charStart.putExtra("mem2", teamSetup[1]);
                    charStart.putExtra("mem3", teamSetup[2]);
                    charStart.putExtra("mem4", teamSetup[3]);
                    charStart.putExtra("game mode", modeSelection);
                    charStart.putExtra("boss", 0);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(statusButton[0] == false){
                    //show the descriptions
                    if(charSelection[0] == 1){
                        charDesc.setText(R.string.empText);
                    }

                    else if(charSelection[0] == 2){
                        charDesc.setText(R.string.saiText);
                    }

                    else if(charSelection[0] == 3){
                        charDesc.setText(R.string.encText);
                    }

                    else if(charSelection[0] == 4){
                        charDesc.setText(R.string.sagText);
                    }

                    else if(charSelection[0] == 5){
                        charDesc.setText(R.string.pirText);
                    }
                    statusButton[0] = true;
                }
                    ...
                    //display the numbers
                    if(charSelection[0] == 1){
                        charDesc.setText(R.string.empStats);
                    }

                    else if(charSelection[0] == 2){
                        charDesc.setText(R.string.saiStats);
                    }

                    else if(charSelection[0] == 3){
                        charDesc.setText(R.string.encStats);
                    }

                    else if(charSelection[0] == 4){
                        charDesc.setText(R.string.sagStats);
                    }

                    else if(charSelection[0] == 5){
                        charDesc.setText(R.string.pirStats);
                    }

                    statusButton[0] = false;
                }
