    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        standardButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                standardButton.setTextColor(getResources().getColor(R.color.leg_sand));
                standardButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
                bossRushButton.setTextColor(getResources().getColor(R.color.leg_gold));
                bossRushButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                reversalButton.setTextColor(getResources().getColor(R.color.leg_gold));
                reversalButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
        ...
        bossRushButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                //change the color of the buttons
                standardButton.setTextColor(getResources().getColor(R.color.leg_gold));
                standardButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                bossRushButton.setTextColor(getResources().getColor(R.color.leg_sand));
                bossRushButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
                reversalButton.setTextColor(getResources().getColor(R.color.leg_gold));
                reversalButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
            }
        });
        ...
        reversalButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                bossRushButton.setTextColor(getResources().getColor(R.color.leg_gold));
                bossRushButton.setBackgroundColor(getResources().getColor(R.color.leg_teal));
                reversalButton.setTextColor(getResources().getColor(R.color.leg_sand));
                reversalButton.setBackgroundColor(getResources().getColor(R.color.leg_red));
            }
        });
