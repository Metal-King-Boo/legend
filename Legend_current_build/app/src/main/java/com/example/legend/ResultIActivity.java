...
public class ResultIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        switch(modeSelection){
            case 1:
                modeText.setText(R.string.modeName1);
                break;
            case 2:
                modeText.setText(R.string.modeName2);
                break;
            case 3:
                modeText.setText(R.string.modeName3);
                break;
        }
        //set the boss
        ...
        for(int i = 0; i <= 3; i++){
            ...
            if(teamSet[i] == 1){
                switch(i){
                    case 0:
                        players[i].setText(R.string.empName1);
                        break;
                    case 1:
                        players[i].setText(R.string.empName2);
                        break;
                    case 2:
                        players[i].setText(R.string.empName3);
                        break;
                    case 3:
                        players[i].setText(R.string.empName4);
                        break;
                }
            }
            else if(teamSet[i] == 2){
                switch(i){
                    case 0:
                        players[i].setText(R.string.saiName1);
                        break;
                    case 1:
                        players[i].setText(R.string.saiName2);
                        break;
                    case 2:
                        players[i].setText(R.string.saiName3);
                        break;
                    case 3:
                        players[i].setText(R.string.saiName4);
                        break;
                }
            }
            else if(teamSet[i] == 3){
                switch(i){
                    case 0:
                        players[i].setText(R.string.encName1);
                        break;
                    case 1:
                        players[i].setText(R.string.encName2);
                        break;
                    case 2:
                        players[i].setText(R.string.encName3);
                        break;
                    case 3:
                        players[i].setText(R.string.encName4);
                        break;
                }
            }
            else if(teamSet[i] == 4){
                switch(i){
                    case 0:
                        players[i].setText(R.string.sagName1);
                        break;
                    case 1:
                        players[i].setText(R.string.sagName2);
                        break;
                    case 2:
                        players[i].setText(R.string.sagName3);
                        break;
                    case 3:
                        players[i].setText(R.string.sagName4);
                        break;
                }
            }
            else{
                switch(i){
                    case 0:
                        players[i].setText(R.string.pirName1);
                        break;
                    case 1:
                        players[i].setText(R.string.pirName2);
                        break;
                    case 2:
                        players[i].setText(R.string.pirName3);
                        break;
                    case 3:
                        players[i].setText(R.string.pirName4);
                        break;
                }
            }
        }
