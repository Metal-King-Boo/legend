...
public class Boss {
    ...
    public int singleAggro(Hero[] players) {
        ...
        //handle fate and avoid buff as well as death
            ...
            //avoid
            if(players[seed].buffSlot1.equals("avoid") || players[seed].buffSlot2.equals("avoid") || players[seed].buffSlot3.equals("avoid") || players[seed].buffSlot4.equals("avoid") || players[seed].buffSlot5.equals("avoid")){
        ...
        if(players[0].cover || players[0].buffSlot1.equals("taunt") || players[0].buffSlot2.equals("taunt") || players[0].buffSlot3.equals("taunt") || players[0].buffSlot4.equals("taunt") || players[0].buffSlot5.equals("taunt")){
            seed = 0;
        }
        else if(players[1].cover || players[1].buffSlot1.equals("taunt") || players[1].buffSlot2.equals("taunt") || players[1].buffSlot3.equals("taunt") || players[1].buffSlot4.equals("taunt") || players[1].buffSlot5.equals("taunt")){
            seed = 1;
        }
        else if(players[2].cover || players[2].buffSlot1.equals("taunt") || players[2].buffSlot2.equals("taunt") || players[2].buffSlot3.equals("taunt") || players[2].buffSlot4.equals("taunt") || players[2].buffSlot5.equals("taunt")){
            seed = 2;
        }
        else if(players[3].cover || players[3].buffSlot1.equals("taunt") || players[3].buffSlot2.equals("taunt") || players[3].buffSlot3.equals("taunt") || players[3].buffSlot4.equals("taunt") || players[3].buffSlot5.equals("taunt")){
            seed = 3;
        }
    ...
    public String doSkill2(Hero[] players) {
        ...
        for(int i  = 0; i < 4; i++){
            if(players[i].alive){
                ...
                players[i].applyDebuff("crushed", 4);
            }
        }
